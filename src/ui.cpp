...
class UI {
   ...
   public:
    ...
    void show_playing_track(Track* track) {
        ...
        display.println(track->name.substring(0, 15));

        display.setTextSize(2);

        display.setCursor(8, 32);  // 32 = 8 margin + 24px first line
        display.print("Album: ");
        display.println(track->albumName);

        display.setCursor(8, 48);  // 32 = 8 margin + 24px first line + 16px second line
